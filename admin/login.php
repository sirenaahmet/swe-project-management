...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT admin_id, full_name, email, password FROM Admin WHERE email = ?";
        ...
        if($stmt = $conn->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){                    
                    ...
                    $stmt->bind_result($id, $full_name, $admin_email, $hashed_password);
                    if($stmt->fetch()){
...
<body>
    <div class="container">
        <div class="page-header">
            <h1>Admin Login</h1>
            <p>Paws & Hearts Shelter Management</p>
        </div>
        ...
        <div class="auth-form-container">
            ...
            <a href="register.php" class="btn btn-outline">Register Admin Account</a>
        </div>
